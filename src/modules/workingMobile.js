const workingMobile = () => {
        const btns = Array.from(document.querySelector('#scheme-list').children);
        const btnsBlock = document.querySelector('#scheme-list');
        let index = 0;
        let trs = 0;
        const arrowRight = document.querySelector('#nav-arrow-scheme_right');
        const arrowLeft = document.querySelector('#nav-arrow-scheme_left');
